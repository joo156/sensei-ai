      ...
      <div className="surface-card overflow-hidden p-0">
            ...
            <tbody className="divide-y">
              {rows.map((h, i) => (
                ...
                >
                  ...
                  <td className="text-muted-foreground px-5 py-3 whitespace-nowrap">{h.date}</td>
                  <td className="px-5 py-3">
                    <NeutralBadge>{h.agent}</NeutralBadge>
                  </td>
                  <td className="max-w-[220px] truncate px-5 py-3">{h.doc}</td>
                  <td className={cn("px-5 py-3 font-medium", statusTone[h.status])}>{h.status}</td>
        ...
        {rows.length === 0 && (
          <div className="p-12 text-center">
            ...
            <p className="text-muted-foreground mt-1 text-sm">Generate something in AI Studio.</p>
          </div>
        )}
      </div>
    </AppShell>
